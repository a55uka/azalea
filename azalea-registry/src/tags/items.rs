...
pub static AXOLOTL_TEMPT_ITEMS: LazyLock<HashSet<Item>> =
...
pub static MUSIC_DISCS: LazyLock<HashSet<Item>> = LazyLock::new(|| {
    HashSet::from_iter(vec![
...
pub static TOOLS: LazyLock<HashSet<Item>> = LazyLock::new(|| {
    HashSet::from_iter(vec![
        Item::Trident,
        Item::DiamondSword,
        Item::StoneSword,
